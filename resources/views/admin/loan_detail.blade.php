                            ...
                            <div class="card-body box-profile">
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    <li class="list-group-item">
                                        <b>Requested Amount</b> <a class="float-right">1,322</a>
                                    </li>
                                    <li class="list-group-item">
                                        <b>Loan Amount Term</b> <a class="float-right">543</a>
                                    </li>
{{--                                    <li class="list-group-item">--}}
                        ...
                        <div class="card">
                            <div class="card-header p-2">
                                <ul class="nav nav-pills">
                                    <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Employment Details</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Guarantor Details</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Send Email</a></li>
                                </ul>
                            </div><!-- /.card-header -->
                            <div class="card-body">
